...
- map_enc.txt 파일을 생성한 뒤, 지도 데이터 map.txt를 한줄 씩 읽고, AES256 암호화를 통해 map_enc.txt에 한줄 씩 저장한다.
  - map data 불러오기를 map.txt에서 map_enc.txt로 변경
    - map_enc.txt를 한줄 씩 읽고 복호화 처리
